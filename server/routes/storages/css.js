...
router.patch('/edit_css/:id', superAdminOnly, isAdmin, updateStorage1);
router.delete('/delete-css/:id', ensureAuthenticated, superAdminOnly, isAdmin, deleteStorage);
...
router.get('/edit_css/:id', ensureAuthenticated, superAdminOnly, isAdmin, edit_css);
