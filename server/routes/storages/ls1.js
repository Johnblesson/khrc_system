...
router.delete('/delete-ls11/:id', ensureAuthenticated, isAdmin, superAdminOnly, deleteStorage);
router.get('/delete-ls11/:id', ensureAuthenticated, isAdmin, deleteStorage);
router.get('/edit_ls11/:id', ensureAuthenticated, isAdmin, superAdminOnly, edit);
router.patch('/edit_ls11/:id', ensureAuthenticated, isAdmin, superAdminOnly, updateStorage1);
