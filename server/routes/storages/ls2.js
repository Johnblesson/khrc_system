...
router.delete('/delete-ls2/:id', ensureAuthenticated, isAdmin, superAdminOnly, deleteStorage);
router.get('/delete-ls2/:id', ensureAuthenticated, isAdmin, deleteStorage);
router.get('/edit_ls2/:id', ensureAuthenticated, isAdmin, superAdminOnly, edit);
router.patch('/edit_ls2/:id', ensureAuthenticated, isAdmin, superAdminOnly, updateStorage1);
