...
router.delete('/delete-ls2/:id', ensureAuthenticated, superAdminOnly, deleteStorage);
router.get('/delete-ls2/:id', ensureAuthenticated, superAdminOnly, deleteStorage);
router.get('/edit_ls2/:id', ensureAuthenticated, superAdminOnly, edit);
router.patch('/edit_ls2/:id', ensureAuthenticated, superAdminOnly, updateStorage1);
